                    ...
                    <form id="searchform">
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">거래상태</label>
                                        <div class="col-sm-8">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                         ...
                                         <button type="button" onclick="regConnection()" class="btn btn-success custom-button">신규</button>
                                    </div>
                                </td>
                            </tr>
                        </table>
...
function setConnectionList(list){
	$('#connectionTable tbody').empty();
	var str = "";
	for (var i = 0; i < list.length; i++){
		str = "<tr>";
		str+= "<td>"  + (i + 1) + "</td>";
		str+= "<td>" + list[i].connectionCode + "</td>";
		str+= "<td><a href = '#' onclick = \"viewConnection('"+list[i].connectionCode+"')\">" + list[i].connectionName + "</a></td>";
		str+= "<td>" + list[i].ceoName + "</td>";
		str+= "<td>" + list[i].connectionNumber + "</td>";
		str+= "<td>" + list[i].chargeName + "</td>";
		str+= "<td>" + list[i].chargeNumber + "</td>";
		str+= "<td>" + list[i].chargeEmail + "</td>";
		str+= "<td>" + list[i].connectionSt + "</td>";
...
function viewConnection(cd){
	window.open('/connection/view?connectionCode='+cd,'거래처 상세정보','width=700, height=500, history=no, resizable=no, status=no, scrollbars=yes, menubar=no')
}

function regConnection(){
	window.open('/connection/view','거래처 등록','width=700, height=500, history=no, resizable=no, status=no, scrollbars=yes, menubar=no')
}
