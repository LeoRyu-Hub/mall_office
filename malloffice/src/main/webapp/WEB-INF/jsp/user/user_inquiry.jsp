                    ...
                    <form>
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td>
                                    <div class="row mb-3">
                                        <label class="col-sm-4 col-form-label">답변여부</label>
                                        <div class="col-sm-8">
...
<script>
	...
	function setUserList(list){
		...
		for (var i = 0; i < list.length; i++){
			...
			str+= "<td><a href = '#' onclick = \"viewInquiry('"+list[i].userId+"','"+list[i].inquirySq+"')\">" + list[i].title + "</a></td>";
			str+= "<td>" + list[i].inquiryDate + "</td>";
			str+= "<td>" + list[i].anwserYN + "</td>";
...
function viewInquiry(id, seq){ // ? 뒤에 있는 값은 설정해주기 나름?
	window.open('/inquiry/view?userId='+id+'&inquirySq='+seq,'문의내용','width=1000, height=500, history=no, resizable=no, status=no, scrollbars=yes, menubar=no')
		}
